...
# Dat:a source: Energy-Charts.info ("Installed power", Germany), Fraunhofer ISE.
#   Licensed CC BY 4.0 — https://energy-charts.info
# ------------------
#
# PLEASE REFETCH AND VERIFY TO ENSURE ACCURATE CAPACITY
#
# ------------------
